...
LogerWriter_ptr Loger::logerArray[] = { 
                LogerWriter_ptr(new ConsoleLoger(Loger::level[Loger::L_ERROR])),
                LogerWriter_ptr(new ConsoleLoger(Loger::level[Loger::L_WARNING])),
                LogerWriter_ptr(new ConsoleLoger(Loger::level[Loger::L_UNIQ])),
                LogerWriter_ptr(new ConsoleLoger(Loger::level[Loger::L_INFO])),
                LogerWriter_ptr(new ConsoleLoger(Loger::level[Loger::L_TRACE])),
                LogerWriter_ptr(new ConsoleLoger(Loger::level[Loger::L_DEBUG]))
};
